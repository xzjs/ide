...
export default {
  ...
  data() {
    return {
      ...
      category_map: {
        Variables:
          '<category name="变量" custom="VARIABLE" colour="240">' +
          "</category>",
        Decisions:
          ...
          "</category>",
        Iteration:
          '<category name="循环" colour="300">' +
          '<block type="controls_forEach"></block>' +
          "</category>",
        Functions:
          '<category name="方法" custom="PROCEDURE" colour="210">' +
          "</category>",
        Classes:
          '<category name="类" colour="210">' +
  ...
  mounted() {
    this.blockly = Blockly.inject("block", {
